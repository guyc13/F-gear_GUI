...
//		map.latitude.bind(vm.latitude);
//		map.longitude.bind(vm.longitude);
//		map.heading.bind(vm.heading);
...
//                Position currentPos=map.currentPosition, destPoint=map.pdestPoint;
//                Position currentPos=aircraft.currentPosition, destPoint=path.destPoint;
				...
				this.path.setPath(vm.connectToCalcServerVm(ip, port, map.matrix, currentPos, destPoint), currentPos,
						destPoint);
//                map.setPath(vm.connectToCalcServerVm(ip, port, map.matrix, currentPos,destPoint), currentPos,destPoint);
...
//        	Position currentPos=map.currentPosition, destPoint=map.pdestPoint;//
//            map.setPath(vm.getPathFromCalcServerVm(currentPos, destPoint), currentPos,destPoint);
		}
	}
	...
	} // manage the functionality of run script button in case of no script or no
		// server connection
...
//        runScript.setDisable(true);
	...
	} // invoked from joystick class to invoke vm joystick func after limit joystick
		// movment
